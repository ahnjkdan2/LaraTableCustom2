...
class QueryHandler
{
    ...
    public function setCategory($class,$category)
    {

        if (method_exists($class, 'laratablesCategorySearch')) {
            $this->query = $class::laratablesCategorySearch($this->query,$category);
        }
    }
